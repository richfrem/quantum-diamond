# App Hygiene Report
Generated: 2025-11-08T05:40:51.137Z
...
## OpenAPI/contract check (if api/openapi.* exists)
...
## Env hygiene (.env.example vs usage)
...
## Frontend build size (vite build)
...
## Accessibility smoke (storybook/axe optional)

```
(Optional) Integrate axe/lighthouse CI for deeper a11y checks
```
